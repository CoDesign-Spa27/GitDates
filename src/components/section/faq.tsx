  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className={`w-8 h-8 flex items-center justify-center rounded-full ${isOpen ? 'bg-primary text-primary-foreground' : 'bg-muted text-muted-foreground'} transition-all duration-300`}>
  ...
  return (
    <section id="faq" className="py-20 bg-[#0C0A09]">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          <span className="text-primary font-medium">Questions & Answers</span>
        ...
        <div className="max-w-3xl mx-auto bg-card border border-border/50 rounded-2xl shadow-lg overflow-hidden">
        ...
        >
          ...
          <motion.button 
            className="px-6 py-2 bg-primary/10 text-primary font-medium rounded-full hover:bg-primary hover:text-primary-foreground transition-all duration-300"
