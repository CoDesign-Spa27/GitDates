...
const Hero = (props: Props) => {
  ...
  return (
    <div className="relative h-screen w-full pt-5 overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        >
          ...
          >
            Find your perfect pair programmer for life. Where code meets
            chemistry.
          </motion.p>
          ...
          >
            <motion.button
              ...
              whileHover={{ scale: 1.05, backgroundColor: "#FF0072" }}
              whileTap={{ scale: 0.95 }}
            >
              Sign Up with GitHub
            </motion.button>
