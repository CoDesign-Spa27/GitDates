...
import { motion, useAnimation, useScroll, useTransform, AnimatePresence } from "motion/react";
import { Github, Heart, Code, Star, Command, MessageSquare, ChevronDown } from "lucide-react";
...
const Hero = () => {
  ...
  // Testimonials
  const testimonials = [
    { name: "Alex C.", role: "Full Stack Developer", text: "Found my teammate for life here! Our stack compatibility is 100%." },
    { name: "Sam R.", role: "UX Designer", text: "Finally, someone who gets my Figma obsession and doesn't mind my CSS rants." },
    { name: "Jordan T.", role: "DevOps Engineer", text: "We deployed our relationship to production on our first date!" },
  ];
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        animate="animate"
        style={{
          background: 'radial-gradient(circle at 25% 25%, rgba(255, 0, 128, 0.2) 2px, transparent 0), radial-gradient(circle at 75% 75%, rgba(90, 90, 255, 0.2) 2px, transparent 0)',
      ...
      >
        ...
        <div className="mt-24 mb-8">
          ...
          >
            Find your perfect <span className="text-pink-400">pair programmer</span> for life. 
          ...
          >
            <motion.button
              className="group relative px-8 py-4 bg-gradient-to-r from-pink-600 to-purple-600 text-white rounded-full font-semibold text-lg transition-all overflow-hidden"
            ...
            <motion.button
              className="px-8 py-4 bg-transparent border-2 border-white/30 backdrop-blur-sm text-white rounded-full font-semibold text-lg transition-all"
              whileHover={{
                scale: 1.05,
